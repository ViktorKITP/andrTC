...
public class ServiceException {
    ...
    protected List<ServiceException.Messages> messages;
     ...
     * {@link ServiceException.Messages }
     * 
     * 
     */
    public List<ServiceException.Messages> getMessages() {
        if (messages == null) {
            messages = new ArrayList<ServiceException.Messages>();
        }
